<?php
/**
 * Script para importar dados limpos de 2023 para o banco
 *
 * IMPORTANTE: Este script é específico para 2023.
 * Para outros anos, adaptar conforme estrutura da planilha.
 *
 * Pré-requisito: Executar limpar_csv_2023.php primeiro
 */

require_once __DIR__ . '/../src/config.php';
require_once __DIR__ . '/../src/db.php';

$file_in = __DIR__ . '/../public/data/filiados_2023_limpo.csv';
$ano = 2023;

if (!file_exists($file_in)) {
    die("Erro: Execute primeiro limpar_csv_2023.php para gerar o CSV limpo.\n");
}
...
echo "\n=== PRÓXIMO PASSO ===\n";
echo "Execute verificação de duplicatas:\n";
