 ...
 * estiver na lista do evento recebe um link de uso unico, valido por pouco
...
class PainelOrganizacaoService {
     ...
     * atual foi desenhada como janela — link magico de 30 min, sessao de 12 h,
     ...
     */
    public static function podeEscrever(array $evento): bool {
        return false;
    }
