<article>
    ...
    <form method="POST" action="/filiacao/<?= e($ano) ?>/<?= e($token) ?>/vincular-cadastro" style="display: flex; flex-direction: column; gap: 12px;"><?= campo_csrf() ?>
        <input type="hidden" name="match_id" value="<?= e($antigo['id']) ?>">
