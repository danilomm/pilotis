<article>
    <div class="text-center">
        ...
        <?php // AMBIENTE_LOCAL, e nao PAGBANK_SANDBOX: esta tela e a resposta a um
              // POST com email QUALQUER. Preso ao sandbox, bastava religar o modo
              // de teste em producao — que o roteiro preve — para que digitar o
              // email de outra pessoa devolvesse na tela o link que abre o
              // formulario dela, com CPF, telefone e endereco. ?>
