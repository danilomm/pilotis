<article>
    ...
    <div style="display: flex; gap: 10px; margin-bottom: 20px; flex-wrap: wrap;">
        ...
        <?php if ($evento['status'] === 'publicado'): ?>
            <?php
            // Encerrar e reversivel: "Reabrir inscricoes" volta. A pagina do
            // evento NAO sai do ar em nenhum dos dois estados — ela e a unica
            // pagina oficial dele e a URL vai impressa no cartaz. Para parar
            // TUDO existe a chave MANUTENCAO no .env, que e excecao.
            ?>
            <form method="POST" action="/admin/eventos/<?= (int)$evento['id'] ?>/status" style="margin: 0;"><?= campo_csrf() ?>
