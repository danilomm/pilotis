<article>
    ...
    <form method="POST" action="/admin/filiacao/<?= e($filiacao['id']) ?>"><?= campo_csrf() ?>
        ...
        <div class="grid">
            <div>
                ...
                <select id="status" name="status">
                    ...
                    <option value="nao_pago" <?= ($filiacao['status'] ?? '') === 'nao_pago' ? 'selected' : '' ?>>Não pago (campanha encerrada)</option>
                    <option value="cancelado" <?= ($filiacao['status'] ?? '') === 'cancelado' ? 'selected' : '' ?>>Cancelado</option>
                </select>
            </div>
            <div>
